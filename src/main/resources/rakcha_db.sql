...
VALUES (1, 'RyuKyungsoo', '/img/actors/30425.jpg',
        'Traduit de l''anglais-Ryu Kyung-soo est un acteur sud-coréen. Il est connu pour ses rôles dans les séries dramatiques Confession et Itaewon Class'),
       (2, 'Tom Holland', '/img/actors/97434.jpg',
        'Thomas Stanley Holland, dit Tom Holland, né le 1ᵉʳ juin 1996 à Kingston upon Thames'),
       (3, 'Zendaya', '/img/actors/3033.jpg',
        'Zendaya Coleman, dite simplement Zendaya, est une actrice, productrice, mannequin,'),
       (4, 'Tobey Maguire', '/img/actors/40317.jpg',
        'Tobey Maguire, de son vrai nom Tobias Vincent Maguire, né le 27 juin 1975 à Santa Monica'),
       (5, 'Robert Downey Jr', '/img/actors/15329.jpg',
        'Robert Downey Jr. /ˈɹɑbɚt ˈdaʊni ˈd͡ʒunjɚ/, né le 4 avril 1965 à New York, est un acteur et scénariste américain.'),
       (6, 'Chris Hemsworth', '/img/actors/30524.jpg',
        'Christopher Hemsworth, dit Chris, né le 11 août 1983 à Melbourne, est un acteur australien.'),
       (7, 'Chris Evans', '/img/actors/43656.jpg',
        'Christopher Robert Evans est un acteur américain, né le 13 juin 1981 à Boston'),
       (8, 'Cillian Murphy', '/img/actors/85261.jpg',
        'Cillian Murphy, né le 25 mai 1976 à Douglas, est un acteur et musicien irlandais.'),
       (9, 'Tom Hardy', '/img/actors/23056.jpg',
        'Edward Hardy, dit Tom Hardy, né le 15 septembre 1977 à Hammersmith en Angleterre, est un acteur et producteur britannique');
-- --------------------------------------------------------
...
INSERT INTO ` categorie_evenement ` (` ID `, ` Nom_categorie `, ` Description `)
VALUES (1, 'MovieProjection', 'Projections of trendy and popular movies'),
...
INSERT INTO ` categorie_produit ` (` id_categorie `, ` nom_categorie `, ` description `)
VALUES (2, 'POSTER', 'Transform your walls into a movie buff''s dream gallery with our unique cinematic paintings'),
       (3, 'Sculptures',
...
INSERT INTO ` evenement ` (` id_categorie `, ` ID `, ` nom `, ` dateDebut `, ` dateFin `, ` lieu `, ` etat `, `
                           description `, ` affiche_event `)
...
(
  ...
  ` duree ` time NOT NULL,
  ` description ` longtext NOT NULL,
  ` annederalisation ` int
(
  11
) NOT NULL,
  ` isBookmarked ` tinyint
(
  1
) NOT NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE =utf8mb4_unicode_ci;
...
INSERT INTO ` film ` (` id `, ` nom `, ` image `, ` duree `, ` description `, ` annederalisation `, ` isBookmarked `)
VALUES (6, 'Spider', '/img/films/90101.jpg', '02:10:45', 'description ddd', 2008, 0),
       (7, 'Spider-Man: No Way Home', '/img/films/61459.jpg', '02:28:30',
        'Avec l''identité de Spider-Man désormais révélée, celui-ci est démasqué', 2021, 1),
       (8, 'Avengers: Infinity War', '/img/films/6794.jpg', '02:29:41',
        ...
        2018, 1),
       (9, 'Oppenheimer', '/img/films/46637.jpg', '03:00:48',
        'En 1942, convaincus que l''Allemagne nazie est en train de développer une arme nucléaire', 2024, 1),
       (10, 'Venom: Let There Be Carnage', '/img/films/62047.jpg', '01:37:42',
        'Après leur triomphe sur Riot, Eddie Brock et son parasite extraterrestre se sont mis d''accord sur quelques règles de conduite',
        2021, 0),
       (11, 'L''Idée d''être avec toi', '/img/films/79595.jpg', '01:55:36',
       ...
       (13, 'Titanic', '/img/films/43943.jpg', '03:23:40',
        ...
        1997, 0),
       (14, 'En eaux très troubles', '/img/films/82547.jpg', '01:58:15',
        'Une équipe de chercheurs en pleine opération d''extraction minière illégale dans l''océan se retrouve en péril.',
        2023, 0);
-- --------------------------------------------------------
...
INSERT INTO ` film_cinema ` (` film_id `, ` cinema_id `)
VALUES (6, 14),
       (7, 13),
       (7, 14),
       (7, 16),
...
INSERT INTO ` panier ` (` id_produit `, ` idpanier `, ` quantite `, ` idClient `)
VALUES (1, 8, 6, 113),
       (19, 9, 2, 113);
...
INSERT INTO ` produit ` (` id_produit `, ` nom `, ` prix `, ` image `, ` description `, ` quantiteP `, `
                         id_categorieProduit `)
VALUES (1, 'Smoking Joker Pop Art', 50, 'img/produit/smokingjoker.jpg-6633cbcd85b2d.jpg',
        'Printed on thick paper (250 g/m²)\nMaximum color brilliance and high UV resistance', 88, 2),
       (2, 'Le Parrain', 170, 'img/produit/leparrain.jpg-6633cbee570e0.jpg',
        'Printing on thick paper (250 g/m²)\r\nÉclat maximal des couleurs et haute résistance aux UV', 92, 2),
       (3, 'OLD TIMES', 150, 'img/produit/oldtimes.jpg-6633cbff937c8.jpg',
        'Limited edition (n°2/5) Sculpture,Bronze on stone\r\nDimensions Height 30cm,Width 18cm/3.00', 94, 3),
       (4, 'Harry Potter', 30, 'img/produit/harrypotter1.jpg-6633cc2332708.jpg',
        'Discover or rediscover the full text of J.K. Rowling with sublime color illustrations', 100, 4),
       (18, 'tableau conan', 30, 'img/produit/conan.jpg-6633cc4ac1b1c.jpg',
        'Printed on thick paper (250 g/m²), this artwork boasts maximum color brilliance and high UV resistan', 0, 3),
       (19, 'tableau naruto', 50, 'img/produit/naruto.jpg-6633cc6096f96.jpg',
...
INSERT INTO ` ratingfilm ` (` id_film `, ` id_user `, ` rate `)
VALUES (2, 105, 4),
       (6, 105, 3),
       (6, 110, 4),
       (7, 110, 3),
...
INSERT INTO ` salle ` (` id_salle `, ` id_cinema `, ` nb_places `, ` nom_salle `)
VALUES (13, 13, 30, 'Room1'),
       (14, 13, 25, 'Room2'),
       (16, 14, 50, 'salleAli1'),
       (17, 14, 50, 'salleAli2'),
       (18, 15, 30, 'salle 1'),
...
INSERT INTO ` seance ` (` id_seance `, ` id_film `, ` id_salle `, ` id_cinema `, ` HD `, ` HF `, ` date `, ` prix `)
VALUES (1, 6, 16, 14, '16:00:00', '18:00:00', '2024-05-04', 16),
...
INSERT INTO ` seat ` (` id `, ` id_salle `, ` statut `)
VALUES (4884, 13, 'vide'),
       (4885, 13, 'reserve'),
       (4886, 13, 'reserve'),
       (4887, 13, 'reserve'),
...
INSERT INTO ` series ` (` idserie `, ` nom `, ` resume `, ` directeur `, ` pays `, ` image `, ` liked `, ` nbLikes `, `
                        disliked `, ` nbDislikes `, ` idcategorie `)
VALUES (2, 'Peaky blinders', 'A gangster family epic set in 1900s England', 'Matt and Ross Duffer',
        'Birmingham, England,', 'img/series/wmunrwzmgkgfrclabhrrzd1jf49-scaled-6634cf69d1c6b.jpg', 0, 1, 0, 1, 1),
       (4, 'Stranger Things', 'Centers around the residents of the fictional town', 'Matt and Ross Duffer',
        'United States', 'img/series/9781532143892-66360efa12050.jpg', 0, 0, 0, 0, 3),
       (5, 'Friends', 'navigates romantic relationships, career challenge', 'Julie Andem', 'United States',
        'img/series/2e98c58c758e3080a2cc84682cd66e4b-66360f93123fb.jpg', 0, 1, 0, 0, 4),
       (6, 'Riverdale', 'the teenagers grapple with issues such friendship', 'Roberto Aguirre-Sacasa', 'United States',
        'img/series/138995-663612e9c46b3.jpg', 0, 0, 0, 0, 1),
       (7, 'You', 'he show explores themes of privacy, social media', 'Greg Berlanti', 'United States',
        'img/series/you-6636107863249.webp', 0, 0, 0, 0, 1),
       (8, 'Lucifer', 'blends elements of crime procedural and fantasy', 'Baran bo Odar', 'United States',
        'img/series/lucifer-663610fac8633.jpg', 0, 0, 0, 0, 1),
       (9, 'Skam France', 'five high-school girls who learn about friendship', 'Julie Andem', 'French',
        'img/series/images_2-663611407eedd.jpg', 0, 0, 0, 0, 1),
       (11, 'Fraiser', 'Frasier\" revolves around Frasier''s pretentiousnes', 'David Lee.', 'United States.',
        'img/series/1697025-663611d3c4350.webp', 0, 0, 0, 0, 3),
       (12, 'Glitch', 'The series follows local police officer James', 'Tony Krawitz', 'Australia',
        'img/series/glitch_tv_show_australian_series_netflix-6636122661186.jpg', 0, 0, 0, 0, 3),
...
(
  ...
  ` roles ` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '(DC2Type:json)' CHECK
(
  json_valid
(
  `
...
INSERT INTO ` users ` (` id `, ` nom `, ` prenom `, ` num_telephone `, ` password `, ` role `, ` adresse `, `
                       date_de_naissance `, ` email `, ` photo_de_profil `, ` is_verified `, ` roles `, ` totp_secret `)
...
--
ALTER TABLE ` commande `
  ADD CONSTRAINT ` FK_6EEAA67DA455ACCF ` FOREIGN KEY (` idClient `) REFERENCES ` users ` (` id `) ON
DELETE CASCADE;
...
--
ALTER TABLE ` commandeitem `
  ADD CONSTRAINT ` FK_55202BB43D498C26 ` FOREIGN KEY (` idCommande `) REFERENCES ` commande ` (` idCommande `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` commentaire_produit `
  ADD CONSTRAINT ` FK_5A6D7E7499DED506 ` FOREIGN KEY (` id_client_id `) REFERENCES ` users ` (` id `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` film_actor `
  ADD CONSTRAINT ` FK_DD19A8A910DAF24A ` FOREIGN KEY (` actor_id `) REFERENCES ` actor ` (` id `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` film_category `
  ADD CONSTRAINT ` FK_A4CBD6A812469DE2 ` FOREIGN KEY (` category_id `) REFERENCES ` category ` (` id `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` film_cinema `
  ADD CONSTRAINT ` FK_BF7139BE567F5183 ` FOREIGN KEY (` film_id `) REFERENCES ` film ` (` id `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` panier `
  ADD CONSTRAINT ` FK_24CC0DF2A455ACCF ` FOREIGN KEY (` idClient `) REFERENCES ` users ` (` id `) ON
DELETE CASCADE,
...
--
ALTER TABLE ` salle `
  ADD CONSTRAINT ` FK_4E977E5CF2B4B159 ` FOREIGN KEY (` id_cinema `) REFERENCES ` cinema ` (` id_cinema `) ON
DELETE CASCADE;
...
--
ALTER TABLE ` seat `
  ADD CONSTRAINT ` FK_3D5C3666A0123F6C ` FOREIGN KEY (` id_salle `) REFERENCES ` salle ` (` id_salle `) ON
DELETE CASCADE;
