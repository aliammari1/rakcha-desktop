...
public class Main {
    public static void main(String[] args) {
        ...
        User responsable_de_cinema = new Responsable_de_cinema("John", "resp", 1000, "password",
                "responsable de cinema", "ariana",
                new Date(100, 8, 9), "responsable_de_cinema@rakcha.tn", "C:\\Users\\AliAMMARI\\Downloads\\cinema.jpg");

        User client = new Client("John", "client", 1000, "password", "client", "ariana",
                new Date(101, 7, 6), "client@rakcha.tn", "C:\\Users\\AliAMMARI\\Downloads\\cinema.jpg");
