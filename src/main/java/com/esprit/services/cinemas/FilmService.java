...
public class FilmService implements IService<Film> {
    ...
    public Film getFilm(int film_id) {
        ...
        try {
            ...
            ResultSet rs = pst.executeQuery();
            rs.next();
            film = new Film(rs.getInt("id"), rs.getString("nom"), rs.getBlob("image"), rs.getTime("duree"), rs.getString("description"), rs.getInt("annederalisation"), rs.getInt("idcinema")) ;
    ...
    public List<Film> readMoviesForCinema(int cinemaId) {
        ...
        try (PreparedStatement pst = connection.prepareStatement(query)) {
            ...
            while (rs.next()) {
                ...
                Film film = new Film(rs.getInt("id"), rs.getString("nom"), rs.getBlob("image"), rs.getTime("duree"), rs.getString("description"), rs.getInt("annederalisation"), rs.getInt("idcinema")) ;
