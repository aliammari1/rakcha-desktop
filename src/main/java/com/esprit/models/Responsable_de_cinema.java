...
public class Responsable_de_cinema extends User {
    ...
    public Responsable_de_cinema(int id, String nom, String prenom, int num_telephone, String password, String role, String adresse, Date date_de_naissance, String email, File file) {
    ...
    public Responsable_de_cinema(int id, String nom, String prenom, int num_telephone, String password, String role, String adresse, Date date_de_naissance, String email) {
