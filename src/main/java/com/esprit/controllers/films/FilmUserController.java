...
public class FilmUserController {
    ...
    void addCommentaire() {
        ...
        if (message.isEmpty()) {
            ...
            final Review commentaire = new Review(message, (Client) new UserService().getUserById(4L), // Fixed
                // type
    ...
    private AnchorPane createFilmCard(final Film film) {
        ...
        final Review ratingFilm = new ReviewService().ratingExists(film.getId(), 2L);
    ...
    private void showFilmDetails(Film film) {
        ...
        final Review ratingFilm1 = new ReviewService().ratingExists(film1.getId(), 2L);
        if (this.filmRate != null) {
            ...
            this.filmRate.ratingProperty().addListener((observableValue, oldVal, newVal) -> {
                ...
                final Review existingRating = ratingFilmService.ratingExists(film1.getId(), 2L);
                if (null != existingRating) {
                    ratingFilmService.delete(existingRating);
                }
                ratingFilmService
                    .create(new Review(film1, (Client) new UserService().getUserById(2L), newVal.intValue()));
