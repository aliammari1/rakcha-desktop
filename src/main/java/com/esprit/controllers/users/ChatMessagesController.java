...
public class ChatMessagesController {
    ...
    @FXML private TextField searchConversationsField;
    @FXML private TextArea messageInput;
    @FXML private ImageView recipientAvatar;
    @FXML private Label recipientNameLabel;
    @FXML private Label recipientStatusLabel;
    @FXML private Label typingIndicatorLabel;
    @FXML private Button sendButton;
    @FXML private Button attachButton;
    @FXML private Button emojiButton;
    @FXML private VBox noConversationBox;
