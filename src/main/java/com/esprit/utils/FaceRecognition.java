...
public class FaceRecognition {
    ...
    // will be saved in the project folder named "/Faces" using a naming convention
    // such as
    // 1_ABC1.jpg
    // 1_ABC2.jpg
    // 1_ABC3.jpg
    ...
    // 1_ABC10.jpg
    //
    // The initial value of the file name is the index key in the database table of
    // that person.
