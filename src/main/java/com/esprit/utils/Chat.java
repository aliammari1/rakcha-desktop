...
public class Chat {
    ...
    public String badword(String message) {
        String question = "detecter si le discours de contenu de la publication est haineux ou non si il ya haineux votre reponse doit etre 100% correcte afficher 1 si non afficher 0 just dit 0 ou 1 idont need anything else "
                + message;
        try {
            String completion = chatGPT(question);
            ...
            // Gérer les erreurs liées à l'API ChatGPT
            LOGGER.info("Erreur lors de la détection de mots grossiers : " + e.getMessage());
            return "-1"; // Retourner une valeur d'erreur spécifique
        }
    }
}
